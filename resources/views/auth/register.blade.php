...
<div style="background-color: #131313"> 
    <main class="mx-auto sm:max-w-lg p-10">
        <div class="flex">
            <div class="w-full">
                <section style="background-color: #333" class="flex flex-col break-words text-gray-200 sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                    ...
                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="name" type="text" style="background-color: #333" class="form-input w-full @error('name')  border-red-500 @enderror"
